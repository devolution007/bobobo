...
return temp}
var cat  = new Array ("Новый","Товар","Сломан","Плагины","Изображения","Google Map","AJAX Bootstrap","шаблоны","Галерея","Иконки","Меню","Кнопки","Премиум","формы","Интернет-магазин","Веб-дизайн","Комментарии","Анимация","QR код SEO","Рейтинг");
ab=0;
document.write('<footer class="blockquote-footer">	<cite title="Source Title"> ');
for (a=0; a < 5; a++){document.write(' ');
for (b=0; b < 4; b++){document.write(' >');
...
if (genRandom(100)>0) {document.write('auction_search.php?keywords_search='+cat[ab]+'');}
 ...
 document.write(' onMouseOver=\"window.status=\'auction_search.php/'+cat[ab]+'/'+(c+1)+'.html\'; return true;\" onMouseOut=\"window.status=\'\';\">'+cat[ab].toUpperCase()+'</a> ');}
document.write('');
//document.write('');
document.write(' ');ab++}
document.write(' ');}
