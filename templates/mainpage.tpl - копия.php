...
<i class="icon-youtube"></i>
 </a> <?=item_pics($item_details);?>      <br /></p>  </div>
 <div class="cap2">
 ...
 <?=$item_details['country'];?></a></p>  </div> </div>
